...
class SimulationTest {
    ...
    void parse() {
        ...
        List<MoveDirection> parsedDirections = null;
        Exception exception = null;
        try {
            parsedDirections = OptionsParser.parse(input);
        } catch (IllegalArgumentException e) {
            exception = e;
        }

        assertNotNull(exception, "Parsing should throw an exception for invalid input");
